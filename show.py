	...
	for c in commands:
		if c["type"] == "repeat":
			...
			if not insideBoard(*pos):
				continue
			if (not c["force"]) and BOARD[pos[1]][pos[0]]:
				continue
...
while running:
	...
	for event in pygame.event.get():
		if event.type == pygame.QUIT:
			...
			if insideBoard(*pos) and BOARD[pos[1]][pos[0]] != 0:
